    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {["WHEN YOU", "NEED US", "WE ARE THERE."].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            {hero.trustBadge} &middot; 6 Staley Rd &middot; Est. 2015
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          KAMEL TOW &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ["TOWING", "RECOVERY", "ROADSIDE ASSIST", "TRANSPORT", "FLEET SERVICES", "HEAVY RECOVERY"];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Founded with a singular mission: to deliver the highest quality towing recovery services in Zimbabwe. What began as a small operation has grown into one of Harare's most trusted names.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Today, with a team of experienced professionals and 26+ satisfied clients, our track record speaks for itself. We bring the same meticulous attention to detail to every single project.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              ...
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">26+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Clients</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">4.5</div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="KAMEL TOW professional work"
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">KAMEL</span>
            </h2>
